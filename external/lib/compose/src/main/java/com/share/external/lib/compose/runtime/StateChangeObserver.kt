 ...
 *
 * Implement this interface to monitor and react to [androidx.compose.runtime.MutableState]
 * and [androidx.compose.runtime.derivedStateOf] changes.
 *
 ...
 */
interface StateChangeObserver : CloseableRegistry {
