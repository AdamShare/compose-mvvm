 ...
 *
 * Implement this interface to monitor and react to [MutableState] and [derivedStateOf] changes.
 ...
 *
 * This observer is intended to be used in conjunction with [StateChangeObserverRegistry],
