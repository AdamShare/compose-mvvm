package com.getbackcompose.foundation.coroutines.test
...
/**
 * A JUnit [org.junit.rules.TestRule] that sets the Main dispatcher
 * to [testDispatcher] for the duration of the test.
 */
