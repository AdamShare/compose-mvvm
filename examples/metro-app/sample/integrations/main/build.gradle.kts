...
kotlin {
    android {
        namespace = "com.share.sample.metro.integrations.main"
        compileSdk = 36
        minSdk = 24
        compilerOptions {
    ...
    sourceSets {
        commonMain.dependencies {
            ...
            implementation(projects.examples.metroApp.sample.feature.main)
            implementation(projects.examples.metroApp.sample.feature.onboarding)
